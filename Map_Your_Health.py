...
#     # list of patients under a doctor
                    ...
                    if email_input == dr_list[i].doctor_mail:
                        ...
                        while flag2 == False:
                            ...
                            if password_input == "":
                                ...
                                password_input == dr_list[i].doctor_password
                                flag2 = True
    ...
    def Patient_personal_details(self,dr, pat_id):
        ...
        for pat in dr.patient_list:
            if pat.patient_id == pat_id:
                ...
                df={"Patient ID" : pat.patient_id,
                    ...
                    "Current diseases" : pat.current_diseases,
                    "Current medications" : pat.current_medications,
                    "Current BP (mmHg)" : pat.current_bp,
                    "Current BMI" : pat.current_bmi,
                    "Current WBC" : pat.current_wbc,
                    "Current RBC" : pat.current_rbc
                }
                st.dataframe(df)
                break
        if flag==0:
    ...
    def dr_signUp(self,dr_list):
        ...
        if st.button('Signup'):
            ...
            write=csv.writer(new_file)
            write.writerow(("Patient ID","Patient Name","Age","Address","Phone No","Gender","Email","Password","Past surgeries","Current diseases","Current medications","Current BP (mmHg)","Current BMI","Current WBC","Current RBC"))
            st.write("Successfully Signed up")
        ...
        for i in dr_list:
            for j in i.patient_list:
                if j.patient_mail == email:
                    ...
                    return
        password = st.text_input("Enter Password:")
        doc = st.text_input("Enter your doctor Email:")
...
while True:
    ...
    choose = st.sidebar.selectbox("Select user", ["Login as Doctor", "Login as Patient", "SignUp as Doctor", "SignUp as Patient", "Terminate"],key="unique")
    ...
    if choose == "Login as Doctor":
       ...
       if dr_obj_login is None:
           ...
           while choose != 0:
            choose = st.selectbox(
                "Select an option:",
                ["View Personal Details", "View Patient List", "Share Patient Details",  "Appointments","Prescribe Medication", "Logout"]
            )
            ...
            if choose == "View Personal Details":
               ...
               # pat_obj.read_csv_patient("C:\\Users\\anush\\Documents\\Buffer\\Patient-Doctor - Patient List 1.csv",dr_list[0].patient_list)
        ...
        for i in range (len(dr_list)):            
            ...
            if (p_obj_login.patient_id == "") :# patient mail is found terminate for loop
                continue
            else:
                break  # else continue the iteration          
        if (p_obj_login == None) :
            ...
            while True:
                choose = st.selectbox("Select an option:", ["View Personal Details", "View Medical Details", "View scheduled appointments",
                ...
                if choose == "View Personal Details":
                    ...
                    p_obj_login.view_medical_details()
